  ...
  return (
    <div className="relative ">
      ...
      {notificationBox && notification && (
        <div className="notificationBox absolute w-[300px] -left-[calc(100%_+_220px)] top-[calc(100%_+_10px)] border-[#D5DBE7] border rounded-lg">
          ...
          <div className="p-6 h-[200px] overflow-auto">
            <ul>
              {notificationData.map((data, index) => (
                <li key={index} className="flex justify-between  gap-x-3 mb-6">
